# This code is refer to https://github.com/JostineHo/mememoji/tree/master/src
...
if __name__ == '__main__':
    ...
    print 'Creating the datasets using 1 percent data from FER2013'
    X_train, y_train, emo_dict = load_data(sample_split=0.01, classes=emo,
                                           verbose=True)
    save_data(X_train, y_train, fname='_sample_1pct')
    print X_train.shape
    print y_train.shape

    print 'Creating the datasets using 100 percent data from FER2013'
    X_train, y_train, emo_dict = load_data(sample_split=1, classes=emo,
                                           verbose=True)
    save_data(X_train, y_train, fname='_sample_total')
    print X_train.shape
    print y_train.shape
